...
import type { ExternalBlob as _ExternalBlob, Room as _Room, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addRoom(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Array<string>, arg5: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRoom(arg0, arg1, arg2, arg3, arg4, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRoom(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: Array<string>, arg5: Array<ExternalBlob>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRoom(arg0, arg1, arg2, arg3, arg4, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadRoomPhoto(arg0: string, arg1: ExternalBlob): Promise<Array<ExternalBlob>> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadRoomPhoto(arg0, await to_candid_ExternalBlob_n9(this._uploadFile, this._downloadFile, arg1));
...
async function from_candid_Room_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Room): Promise<Room> {
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Room>): Promise<Array<Room>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Room_n13(_uploadFile, _downloadFile, x)));
}
